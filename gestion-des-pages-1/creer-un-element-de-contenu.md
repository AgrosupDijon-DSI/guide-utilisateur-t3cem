...
* Cliquer sur l’icône ![](../.gitbook/assets/add_content_btn.png) **Contenu** dans la [Vue détaillée](../prise-en-main/se-reperer-dans-le-backend.md) pour créer un nouvel élément de contenu dans la page.
